...
from .models import Department, Stream, Timetable
from .models import Stream, LectureSlot, Lesson
...
def timetable_detail(request, stream_id):
    ...
    timetable = Timetable.objects.first()  # Simplified, update as needed
...
def timetable_detailed_view(request, stream_id):
    ...
    # Organize lecture slots by lesson for this stream
